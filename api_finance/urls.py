...
from .views import (
    ...
    FinancialSourceListView,
    FinancialSourceCreateView,
    FinancialSourceDetailView,
    FinancialSourceUpdateView,
    FinancialSourceDeleteView,
    IncomePlanListView,
    IncomePlanCreateView,
    IncomePlanDetailView,
    IncomePlanUpdateView,
    IncomePlanDeleteView,
    IncomeListView,
    IncomeCreateView,
    IncomeDetailView,
    IncomeUpdateView,
    IncomeDeleteView,
    ExpensePlanListView,
    ExpensePlanCreateView,
    ExpensePlanDetailView,
    ExpensePlanUpdateView,
    ExpensePlanDeleteView,
    ExpenseListView,
    ExpenseCreateView,
    ExpenseDetailView,
    ExpenseUpdateView,
    ...
    InvestmentPlanCreateView,
    InvestmentPlanDetailView,
    InvestmentPlanUpdateView,
    InvestmentPlanDeleteView,
    DebtListView,
    DebtCreateView,
    DebtDetailView,
    DebtUpdateView,
